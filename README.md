...
- `CODEX_GRADLE_JAVA_HOME`: explicit JDK home used by Gradle preflight and worker Gradle commands
...
- The Gradle helper uses `CODEX_GRADLE_JAVA_HOME` when the user supplies an explicit JDK path; it does not scan the machine for installed JDKs.
